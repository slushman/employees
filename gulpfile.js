 ...
 * sudo npm install --save-dev gulp-sourcemaps gulp-autoprefixer gulp-filter gulp-cssnano gulp-sass gulp-concat gulp-uglify-es gulp-notify gulp-imagemin gulp-rename gulp-wp-pot gulp-sort gulp-parker gulp-svgmin gulp-size gulp-readme-to-markdown
 * gulp
 *
 * Implements:
...
var project = {
	...
	'i18n': {
		'domain': 'employees',
		'destFile': 'languages/employees.pot',
		'package': 'Employees',
		'bugReport': 'https://github.com/dccmarketing/employees/issues',

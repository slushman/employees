...
<nav class="help-nav">
	<ul>
		...
		<li><a href="#build-layout">Build a Layout</a></li>
		<li><a href="#block">Block</a></li>
	</ul>
</nav>

<h2 id="shortcode">Shortcode</h2>
<p>To display a list of employees on a page, use the following shortcode. The simplest version of the shortcode is:</p>
...
<p>The department attribute also accepts comma-separated lists of departments slugs to display employees from more than one department.
<p>Example:</p>
<ul>
	<li>department="sales,creditors-rights"</li>
</ul>
<h2 id="build-layout">Building a Layout in the Shortcode</h2>
<p>Employees comes with a simple layout for the shortcode. While developers should be able change the layout using action hooks, a site admin can use the shortcode to create a layout of their choosing. By default, the employee list layout is image, name, and job title.</p>
...
<h2 id="block">Employee List Block</h2>